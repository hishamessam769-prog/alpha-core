  ...
  return (
    <div className="public-page landing-v3">
      ...
      <main>
        ...
        <Reveal as="section" className="cta-v21 cta-v3" delay={100}><div><ShieldCheck size={31}/><span className="eyebrow">ALPHA PLATFORM V3.4</span><h2>{isArabic ? "ادخل منصة استثمارية مصممة للقرار" : "Enter an investment platform designed for decisions"}</h2><p>{isArabic ? "محافظ وأبحاث وتوصيات وتقارير في تجربة مؤسسية واحدة." : "Portfolios, research, recommendations and reports in one institutional experience."}</p></div><Link className="button gold large" to="/signup">{isArabic ? "ابدأ الآن" : "Get started"}<span>{arrow}</span></Link></Reveal>
      </main>
      <PlatformFooter />
    </div>
  );
