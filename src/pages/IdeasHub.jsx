    ...
    <div className="dashboard-shell research-shell-v22 research-shell-v3">
      ...
      <main className="research-page-v22 research-page-v3">
        <section className="research-magazine-hero-v3">
          <div className="research-hero-copy-v3"><span className="eyebrow">ALPHA RESEARCH · INDEPENDENT EQUITY INTELLIGENCE</span><h1>{isArabic ? "أبحاث استثمارية تقود إلى قرار واضح" : "Research designed to end in a clear investment decision"}</h1><p>{isArabic ? "كل توصية تجمع السعر والفرضية والتقييم والمحفزات والمخاطر والأداء مقابل المؤشر في صفحة واحدة." : "Every recommendation brings price, thesis, valuation, catalysts, risks and benchmark-relative performance into one decision page."}</p><div className="research-hero-actions-v3"><InsightDrawer label={isArabic ? "ملخص المكتبة" : "Summarise the library"} title={isArabic ? "ملخص التوصيات" : "Recommendation library brief"} summary={librarySummary}/><span><BadgeCheck size={16}/>{isArabic ? "سجل زمني غير قابل للمحو" : "Permanent dated record"}</span></div></div>
        ...
        <section className="research-toolbar-v22 research-toolbar-v3" id="research-library">
          <div><span className="eyebrow">RESEARCH LIBRARY</span><h2>{isArabic ? "كل التوصيات المنشورة" : "All published recommendations"}</h2></div>
